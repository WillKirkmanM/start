...
interface PinnedLinksGridProps {
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
        {pinnedLinks
          ...
          .map(link => (
            ...
            >
              <div className="w-10 h-10 mb-2 flex items-center justify-center bg-zinc-800 rounded-full overflow-hidden">
                <img 
              ...
              <span className="text-sm truncate w-full">{link.title}</span>
            </a>
          ))}
      </div>
    </div>
...
export default PinnedLinksGrid;